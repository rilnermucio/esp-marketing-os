...
> **SNAPSHOT DATADO (fev/2026)**: modelos, preços e planos mudam em ciclos de meses. Antes de recomendar ferramenta ou citar preço desta lista, confirme o estado atual via WebSearch. A taxonomia (tiers e critérios de escolha) envelhece bem; nomes de modelos e valores específicos, não.
...
> **SNAPSHOT DATADO (início de 2026)**: esta seção fotografa um momento do mercado. Quanto mais longe dessa data, menor a confiança. Antes de basear recomendação em tendência, ferramenta ou preço daqui, confirme via WebSearch que ainda vale. Os princípios (autenticidade, prova, especificidade) envelhecem bem; números, nomes de ferramentas e preços envelhecem mal.
...
2. FEATURES EM VEZ DE BENEFÍCIOS
   ❌ "40 horas de conteúdo em vídeo"
   ✓ "Domine [habilidade] em 30 dias, mesmo sem experiência"

3. GENÉRICO EM VEZ DE ESPECÍFICO
   ❌ "Ganhe mais dinheiro"
   ✓ "Gere R$5.327 extras por mês"

4. VOZ PASSIVA
   ❌ "Resultados serão alcançados"
   ✓ "Você vai alcançar resultados"
...
6. MÚLTIPLOS CTAs
   ❌ "Compre agora / Saiba mais / Entre em contato / Baixe grátis"
   ✓ Um CTA principal, repetido estrategicamente

7. HEADLINE SEM BENEFÍCIO
   ❌ "Bem-vindo ao nosso site"
   ✓ "O método para [resultado] em [tempo]"

8. TEXTO MUITO LONGO SEM QUEBRAS
   ❌ Parágrafos de 10 linhas
   ✓ Parágrafos de 1-3 linhas, espaçamento

9. JARGÃO TÉCNICO DESNECESSÁRIO
   ❌ "Solução omnichannel com stack integrado"
   ✓ "Venda em todos os canais sem complicação"

10. PROMETER SEM PROVAR
    ❌ "O melhor produto do mercado"
    ✓ "Escolhido por 12.000 clientes. Nota 4.9/5"
...
13. SEM PROVA SOCIAL
    ...
    ✓ Cases, reviews, números, logos

14. HOOK FRACO
    ❌ "Olá, tudo bem?"
    ✓ "R$47.000 em 60 dias com 800 inscritos"

15. MUITO TEXTO, POUCA FORMATAÇÃO
    ❌ Texto corrido sem bullets ou destaques
    ✓ Bullets, negritos, espaços, subheadlines

16. NÃO CONHECER O PÚBLICO
...
19. IGNORAR MOBILE
    ...
    ✓ Copy que funciona bem em tela pequena

20. NÃO REVISAR
    ❌ Erros de português, links quebrados
...
Dois trilhos mantêm os swipe-files vivos: um automático (pessoal, por projeto) e um curado (distribuído com o plugin).

**Trilho 1 (automático): swipe file pessoal em `workspace/swipe-files/aprovados.md`**

Quando o usuário aprova explicitamente uma peça ou reporta resultado de A/B test:

1. **Identifique** qual variação ganhou e por qual margem
2. **Faça append** em `workspace/swipe-files/aprovados.md`, criando o arquivo na primeira vez. O path é sempre relativo ao projeto do usuário (`workspace/` é pessoal e gitignored); nunca escreva no install dir do plugin
3. **Formato do registro:**
   ...
   ```
4. Na sessão seguinte, esse arquivo é lido ANTES dos swipe-files genéricos (ver Protocolo de Invocação §2 do Tier 1). Winner registrado vira referência ativa

**Trilho 2 (curado): swipe-files distribuídos em `assets/swipe-files/`**

São assets versionados do plugin; não escreva neles em runtime. Quando um winner do trilho 1 merecer virar referência permanente do plugin, sugira ao usuário promover a peça via commit/PR no repositório:
...
**Por que isso importa**: o swipe-file genérico de hoje, com 6 meses de trilho 1, vira **swipe-file proprietário** com winners testados no contexto/nicho específico do usuário. Cada projeto compounding.
