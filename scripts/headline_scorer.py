...
POWER_WORDS = {
    "urgencia": [
        "agora", "hoje", "imediato", "último", "limitado", "urgente",
        "rápido", "instantâneo", "deadline", "antes", "enquanto"
    ],
    "curiosidade": [
        "segredo", "revelado", "descobrir", "surpreendente", "chocante",
        "verdade", "mistério", "escondido", "nunca", "finalmente"
    ],
    "valor": [
        "grátis", "gratuito", "bônus", "exclusivo", "especial",
        "premium", "vip", "presente", "oferta", "desconto"
    ],
    "confianca": [
        "comprovado", "garantido", "científico", "testado", "validado",
        "certificado", "oficial", "autêntico", "aprovado", "seguro"
    ],
    "emocao": [
        "incrível", "fantástico", "extraordinário", "poderoso", "épico",
        "transformador", "revolucionário", "essencial", "definitivo", "máximo"
    ],
    "medo": [
...
def score_headline(headline: str) -> Dict:
    ...
    if not power_words:
        results["suggestions"].append("Adicione palavras de poder (ex: 'comprovado', 'segredo', 'grátis')")
    if not patterns:
        results["suggestions"].append("Use um padrão eficaz (ex: comece com número, 'Como...', ou pergunta)")
    if not has_number:
